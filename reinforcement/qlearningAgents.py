...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        if stateAction not in self.QValues:
          return 0.0
        return self.QValues[stateAction]
    ...
    def computeValueFromQValues(self, state):
        ...
        if not actions:
          ...
          highest = self.getQValue(state, actions[0])
    ...
    def computeActionFromQValues(self, state):
        ...
        highest = self.getQValue(state, legalActions[0])
        ...
        for action in legalActions[1:]:
          ...
          """
          elif currQValue == highest:
            y = [currQValue, highest]
            highestAction = random.choice(y)
          """
    ...
    def getAction(self, state):
        ...
        action = None
        "*** YOUR CODE HERE ***"
        # random choice with chance epsilon, otherwise take best action
        if not legalActions:
          return None
    ...
    def update(self, state, action, nextState, reward):
        ...
        sample = reward + (self.discount * Qprime)
        nextQ = (1 - self.alpha)*self.getQValue(state, action) + (self.alpha * sample)
